...
import (
	...
	"nutrition-service/internal/repository"
	"nutrition-service/internal/service"
	"nutrition-service/internal/transport/client"
	"nutrition-service/internal/transport/server"
...
func main() {
	...
	s := grpc.NewServer()
	pb.RegisterNutritionServiceServer(s, serviceServer)

	log.Printf("nutrition-service listening on :%s", grpcPort)
